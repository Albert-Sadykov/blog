		...
		<div class="content grid_content">
			<div class="left_container">
				...
				<div class="grid_blog">
					...
					<?php
						...
						$sql_query = "SELECT * FROM `articles` WHERE `categorie_id` = $"
					?>
				</div>
			</div>
			<div class="right_container">
				...
				<div class="categories_conteiner">
					...
					<div class="categorie"><a href="">Категория 1</a></div>
					<div class="categorie"><a href="">Категория 2</a></div>
					<div class="categorie"><a href="">Категория 3</a></div>
					<div class="categorie"><a href="">Категория 4</a></div>
					<div class="categorie"><a href="">Категория 5</a></div>
					<div class="categorie"><a href="">Категория 6</a></div>
					<div class="categorie"><a href="">+  Добавить статью</a></div>
				</div>
			</div>
		</div>
		<footer class="footer">
